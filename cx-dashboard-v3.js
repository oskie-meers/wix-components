...
@font-face { font-family: 'TTCommons'; src: url('https://cdn.jsdelivr.net/gh/oskie-meers/fonts@v1.0.0/TTCommons-DemiBold.woff2') format('woff2'); font-weight: 600; }
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  :host { display: block; font-family: 'TTCommons', sans-serif; background: transparent; padding: 48px; color: #1e3a5f; width: 100%; box-sizing: border-box; overflow-x: hidden; }

  .dash { max-width: 1600px; margin: 0 auto; width: 100%; box-sizing: border-box; }

  .top-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 24px; width: 100%; box-sizing: border-box; }
  .metric { background: #f4f7fa; border-radius: 14px; padding: 28px 32px; box-sizing: border-box; min-width: 0; }
  ...
  .charts-row { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px; align-items: start; width: 100%; box-sizing: border-box; }
  .chart-card { background: white; border: 1px solid rgba(30,58,95,0.08); border-radius: 16px; padding: 32px; width: 100%; box-sizing: border-box; min-width: 0; }
  .chart-title { font-size: 13px; font-weight: 600; color: #6b85a0; margin-bottom: 24px; letter-spacing: 0; }

  .bar-row { display: flex; align-items: center; gap: 8px; margin-bottom: 14px; width: 100%; box-sizing: border-box; }
  .bar-label { font-size: 14px; color: #4a6585; width: 130px; flex-shrink: 0; line-height: 1.3; font-weight: 300; }
  ...
  .pills-card { background: white; border: 1px solid rgba(30,58,95,0.08); border-radius: 16px; padding: 32px; width: 100%; box-sizing: border-box; }
  .pills-wrap { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 16px; }
  .pill { font-size: 14px; border-radius: 50px; padding: 7px 18px; font-weight: 500; white-space: nowrap; }
  ...
  @media (max-width: 600px) {
    ...
    .pills-card { padding: 16px 14px; }
    .chart-title { margin-bottom: 16px; }
    .bar-label { width: auto; flex: 0 0 35%; font-size: 11px; }
    .bar-track { flex: 1; min-width: 0; }
    .bar-pct { font-size: 11px; width: 26px; }
    .pill { font-size: 11px; padding: 5px 10px; }
    .pills-wrap { gap: 6px; }
    .legend { gap: 6px; margin-top: 12px; }
...
<div class="dash">
  ...
  <div class="charts-row">
    ...
    <div class="pills-wrap">
      <span class="pill pill-light">Chief Customer Officer</span>
      <span class="pill pill-light">General Manager</span>
      <span class="pill pill-light">Head of CX</span>
