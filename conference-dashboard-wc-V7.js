class ConferenceDashboard extends HTMLElement {
  connectedCallback() {
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .logos-row img { height: 56px; width: auto; object-fit: contain; opacity: 0.85; transition: opacity 0.2s; }
    .logos-row a { display: flex; align-items: center; }
    .logos-row a:hover img { opacity: 1; }
    ...
    /* ── REACH CARD ── */
    .reach-items { display: flex; flex-direction: row; gap: 12px; }
    .reach-item {
      flex: 1; display: flex; flex-direction: column; align-items: center; text-align: center;
      padding: 14px 10px; border-radius: 12px; background: #f8fbfb;
    }
    .reach-item-icon {
    ...
    .reach-item-icon svg { width: 16px; height: 16px; }
    .reach-item-icon.email { background: rgba(232,147,58,0.12); }
    .reach-item-icon.social { background: rgba(169,146,184,0.12); }
    .reach-text {}
    .reach-num {
      font-size: 22px; font-weight: 300; letter-spacing: -0.5px; line-height: 1;
      background: linear-gradient(135deg, #2d5a5a 0%, #4a9b94 100%);
      -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
    }
    .reach-label { font-size: 11px; font-weight: 300; color: #6b8585; margin-top: 5px; line-height: 1.4; }
  ...
  <div class="dashboard-inner">
    ...
    <!-- Logos -->
    <div class="logos-row">
      <a href="https://www.salusevents.org/" target="_blank" rel="noopener"><img src="https://static.wixstatic.com/media/958742_08b54cb7e4754b99886a760f7563037e~mv2.png" alt="Salus"></a>
      <div class="logo-divider"></div>
      <a href="https://aventedge.com/" target="_blank" rel="noopener"><img src="https://static.wixstatic.com/media/958742_d4879015538740c682d4bb03146cd517~mv2.png" alt="Aventedge"></a>
      <div class="logo-divider"></div>
      <a href="https://www.womenleadersinstitute.org/" target="_blank" rel="noopener"><img src="https://static.wixstatic.com/media/958742_1aaead04e6e947e29f499c2052aff40e~mv2.png" alt="WLI"></a>
    </div>
