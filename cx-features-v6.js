...
@media (max-width: 560px) { .features { grid-template-columns: 1fr; max-width: 100%; padding: 24px 20px; } }
@media (max-width: 380px) { .features { padding: 20px 16px; gap: 16px; } .feature-card { padding: 24px 20px; } }
</style>
