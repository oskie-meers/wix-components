  ...
  connectedCallback() {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      @media (max-width: 1200px) { .stats-grid { grid-template-columns: repeat(3, 1fr); gap: 50px; } }
      ...
      @media (max-width: 480px) { .stats-grid { grid-template-columns: 1fr; gap: 40px; } .stat-number { font-size: 48px; } }
    `;
