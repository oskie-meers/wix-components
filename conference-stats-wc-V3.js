  ...
  connectedCallback() {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      /* 3-col layout: centre orphan items that don't fill a full row */
      @media (max-width: 1200px) {
        .stats-grid { grid-template-columns: repeat(3, 1fr); gap: 50px; }
        .stat-item:last-child:nth-child(3n + 1) { grid-column: 2 / 3; }
        .stat-item:last-child:nth-child(3n + 2) { grid-column: 2 / 4; }
      }
      ...
      /* 2-col layout: centre lone last item */
      ...
      @media (max-width: 480px) {
        ...
        .icon-wrapper { width: 56px; height: 56px; margin-bottom: 16px; }
    ...
    const stats = [
      {
        ...
        // People — dark outline body, coral fill accent on head
      ...
      },
      {
        ...
        // Microphone — filled body with orange accent
        svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      },
      {
        ...
        // Lightbulb — filled bulb with lavender accent
        svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
