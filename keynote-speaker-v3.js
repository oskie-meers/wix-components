...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :host { display: block; font-family: 'DM Sans', sans-serif; background: #195859; padding: 40px 16px; }
  ...
  .ks-accent {
    ...
    height: 5px;
    background: linear-gradient(90deg, #195859, #B8A4C9);
  }
  ...
  .ks-badge {
    ...
    align-items: center;
    gap: 6px;
    background: rgba(184,164,201,0.13);
  ...
  @media (max-width: 720px) {
    ...
    .ks-name { font-size: 24px; }
    .ks-title { font-size: 14px; margin-bottom: 18px; }
    .ks-bio { font-size: 14px; margin-bottom: 28px; }
    .ks-btn { font-size: 13px; padding: 12px 22px; }
  }
</style>
