      ...
      connectedCallback() {
        ...
        style.textContent = `
          *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          @media (max-width: 1000px) { .stat-item { flex: 0 0 calc(33.333% - 22px); } .stats-grid { gap: 32px; } .stat-number { font-size: 38px; } .icon-wrapper { width: 64px; height: 64px; } .icon-wrapper svg { width: 28px; height: 28px; } }
          @media (max-width: 768px) { .stat-item { flex: 0 0 calc(50% - 20px); } .stats-grid { gap: 28px 20px; } .stat-number { font-size: 32px; } .icon-wrapper { width: 60px; height: 60px; } .stat-label { font-size: 13px; } }
          @media (max-width: 480px) { .stats-section { padding: 16px; } .stat-item { flex: 0 0 calc(50% - 10px); } .stats-grid { gap: 24px 16px; } .stat-number { font-size: 28px; } .icon-wrapper { width: 52px; height: 52px; margin-bottom: 14px; } .icon-wrapper svg { width: 24px; height: 24px; } .stat-label { font-size: 12px; max-width: 140px; } }
        `;
