...
<style>
  ...
  *,*::before,*::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* Zoom controls — absolute inside .fp-root */
  .fp-controls {
    position: absolute;
    bottom: 14px;
    right: 14px;
...
<div class="floor">
  ...
  <div class="fp-controls">
    ...
    <button class="fp-btn" id="fp-zoom-fit" title="Reset" style="font-size:13px;">&#10530;</button>
  </div>
...
`;
    ...
    const root      = shadow.getElementById('fp-root');
    ...
    const tt        = shadow.getElementById('fp-tt');
