...
@font-face { font-family:'TTCommons'; src:url('https://cdn.jsdelivr.net/gh/oskie-meers/fonts@v1.0.0/TTCommons-DemiBold.woff2') format('woff2'); font-weight:600; }
  ...
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
  ...
  .drag-outer.dragging { cursor: grabbing; }
  .floor {
    position:relative;
    width:1300px;
    height:540px;
...
<div class="drag-outer" id="drag-outer">
<div class="floor" id="floor-inner" style="position:relative;will-change:transform;">
...
`;
    ...
    var dragStartX = 0, dragStartY = 0, panX = 0, panY = 0, panStartX = 0, panStartY = 0;
    var dragOuter = shadow.getElementById('drag-outer');
    var floorInner = shadow.getElementById('floor-inner');

    function clampPan(x, y) {
      var maxX = 0;
      var minX = dragOuter.clientWidth - floorInner.offsetWidth;
      var maxY = 0;
      var minY = dragOuter.clientHeight - floorInner.offsetHeight;
      return [
    ...
    function applyPan() {
      var c = clampPan(panX, panY);
      floorInner.style.transform = 'translate(' + c[0] + 'px,' + c[1] + 'px)';
    }

    dragOuter.addEventListener('mousedown', function(e) {
    ...
    // Touch drag
    dragOuter.addEventListener('touchstart', function(e) {
    ...
    dragOuter.addEventListener('touchmove', function(e) {
    ...
    dragOuter.addEventListener('touchend', function() { isDragging = false; });
    ...
    document.addEventListener('click', function(e) {
      if (!e.composedPath().some(function(n) { return n === dragOuter; })) tt.className = 'mhww-tt';
    });
  }
}
